\documentclass[a4paper,11pt]{article} % Määritellään luotavan dokumentin tyyppi

\usepackage{float}
\usepackage{amsmath}        	% Matematiikkapaketti
\usepackage{amssymb}
\usepackage[utf8]{inputenc} 	% UTF-8 merkistö 
\usepackage{lmodern,textcomp}   % Euron merkki ja muuta kivaa
...
\usepackage[english]{babel}	    % Nimeää kuvat, taulukot jne. suomeksi
                                % (muutoin ne nimettäisiin figure 1,
                                % table 1 jne.)
\usepackage{hyperref}
\hypersetup{
    colorlinks=true,
